 ...
 */
@Entity
@Table(name = "document_fields_manager")
@NamedQueries({
    @NamedQuery(name = "DocumentFieldsManager.findAll", query = "SELECT d FROM DocumentFieldsManager d"),
    @NamedQuery(name = "DocumentFieldsManager.findById", query = "SELECT d FROM DocumentFieldsManager d WHERE d.id = :id")})
public class DocumentFieldsManager implements Serializable {
    ...
    public DocumentFieldsManager(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DocumentFieldsManager)) {
            return false;
        }
        DocumentFieldsManager other = (DocumentFieldsManager) object;
    ...
    public String toString() {
        return "lk.exon.temco_loan_system.entity.DocumentFieldsManager[ id=" + id + " ]";
    }
