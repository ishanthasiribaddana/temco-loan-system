    ...
    public void loadLoans() {
        try {
            ...
            for (InterestManager im : interestManagers) {
                ...
                double loanCapitalAmount
                        = roundMoney(lm.getLoanCapitalAmount());
                
                double monthlyInstallment
                        = roundMoney(lm.getMonthlyInstallement());
                ...
                loans.add(new Loan(
                        ...
                        String.valueOf(loanCapitalAmount),
                        formatDate(lm.getDate()),
                        latest != null ? latest.getLoanStatusId().getName() : "Unknown",
                        latest != null ? formatDate(latest.getDate()) : "",
                        String.valueOf(monthlyInstallment),
                        "",
                        im
                ));
            }
            
            this.loanRequests = nonRejectedLoanCount;             // submissions excluding rejected
            this.totalRequestedLoanAmount = totalRequestedAmount; // money excluding rejected
...
//                            ffrontNic = "F:/temco-bank-application-2024-07-08/nilupul copy/temco_loan_system-1.0/target/temco_loan_system-1.0/documents/loan_documents/student_loan/WKXvsjUCrFanU849qbJIbSdlyBQ3mZu8/2011320000000100/temcoln909d9035-41a9-4ee5-ad97-0c41010fa02520240924091318.png";
    ...
    public class Loan {
        ...
        public Loan(String LoanId, String assoNo, String name, String loanAmount, String loanAppliedDate, String payOrderStatus, String PayOrderDate, String downPayment, String lecturesStarted, InterestManager loanMangerObj) {
            this.LoanId = LoanId;
            this.assoNo = assoNo;
            this.name = name;
