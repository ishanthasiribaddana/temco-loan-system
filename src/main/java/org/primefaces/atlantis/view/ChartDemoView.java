...
public class ChartDemoView implements Serializable {
    ...
    public void createBarModel() {
        ...
        bgColor.add("rgba(255, 99, 132, 1.0)");
        bgColor.add("rgba(255, 159, 64, 1.0)");
        bgColor.add("rgba(255, 205, 86, 1.0)");
        bgColor.add("rgba(75, 192, 192, 1.0)");
        bgColor.add("rgba(54, 162, 235, 1.0)");
        bgColor.add("rgba(153, 102, 255, 1.0)");
        bgColor.add("rgba(201, 203, 207, 1.0)");
